    ...
    <div className="h-screen">
      ...
      <div className="h-[85%] sm:flex sm:justify-between sm:items-center">
        <div className="text-center sm:text-left sm:w-[50%] sm:ml-20 text-white">
          <span className="text-3xl font-light sm:font-normal sm:text-5xl">Bienvenue dans notre</span>
          <h2 className="text-5xl sm:text-8xl mt-5 sm:mt-4">Système Solaire</h2>
          <button className="bg-white text-black mt-7 sm:mt-10 rounded-lg px-3 py-2 sm:px-4 sm:py-3 text-2xl sm:text-3xl cursor-pointer">Explorez !</button>
        </div>
